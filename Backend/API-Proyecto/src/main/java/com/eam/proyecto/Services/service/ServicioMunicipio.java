...
import com.eam.proyecto.DTO.Municipio;
 ...
 */
@Path("Municipio")
public class ServicioMunicipio extends EstructuraRestFulNegocio<Municipio> {
    ...
    public Response guardar(Municipio entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Municipio entity) {
