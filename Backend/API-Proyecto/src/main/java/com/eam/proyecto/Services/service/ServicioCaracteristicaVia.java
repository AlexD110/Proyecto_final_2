...
public class ServicioCaracteristicaVia extends EstructuraRestFulNegocio<CaracteristicaVia> {
    ...
    public Response guardar(CaracteristicaVia entity) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_JSON})
    public List<CaracteristicaVia> listar() {
        return super.listar();
    }
