...
import com.eam.proyecto.DTO.TipoInfraccion;
 ...
 */
@Path("TipoInfraccion")
public class ServicioTipoInfraccion extends EstructuraRestFulNegocio<TipoInfraccion> {
    
    public ServicioTipoInfraccion() {
        super(TipoInfraccion.class);
    }
    ...
    public Response guardar(TipoInfraccion entity) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_JSON})
    public List<TipoInfraccion> listar() {
        return super.listar();
    }
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_JSON})
    public List<TipoInfraccion> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
