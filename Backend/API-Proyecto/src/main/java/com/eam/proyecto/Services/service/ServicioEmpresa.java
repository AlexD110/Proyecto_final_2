...
import com.eam.proyecto.DTO.Empresa;
 ...
 */
@Path("Empresa")
public class ServicioEmpresa extends EstructuraRestFulNegocio<Empresa> {
    ...
    public Response guardar(Empresa entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Empresa entity) {
