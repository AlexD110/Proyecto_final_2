...
import com.eam.proyecto.DTO.Curso;
 ...
 */
@Path("Curso")
public class ServicioCurso extends EstructuraRestFulNegocio<Curso> {
    ...
    public Response guardar(Curso entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Curso entity) {
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Curso find(@PathParam("id") BigDecimal id) {
