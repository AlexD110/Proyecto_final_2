 ...
 */
@Path("Lugar")
public class ServicioLugar extends EstructuraRestFulNegocio<Lugar> {
    ...
    public Response guardar(Lugar entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Lugar entity) {
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Lugar find(@PathParam("id") BigDecimal id) {
