...
import com.eam.proyecto.DTO.Tramite;
 ...
 */
@Path("Tramite")
public class ServicioTramite extends EstructuraRestFulNegocio<Tramite> {
    ...
    public Response guardar(Tramite entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Tramite entity) {
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Tramite find(@PathParam("id") BigDecimal id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_JSON})
    public List<Tramite> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
