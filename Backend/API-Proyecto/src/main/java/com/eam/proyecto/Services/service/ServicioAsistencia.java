...
import com.eam.proyecto.DTO.Asistencia;
 ...
 */
@Path("Asistencia")
public class ServicioAsistencia extends EstructuraRestFulNegocio<Asistencia> {
    ...
    public Response guardar(Asistencia entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Asistencia entity) {
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Asistencia find(@PathParam("id") BigDecimal id) {
