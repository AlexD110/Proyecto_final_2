...
public class ServicioRequisitos extends EstructuraRestFulNegocio<Requisitos> {
    ...
    public Response guardar(Requisitos entity) {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") BigDecimal id, Requisitos entity) {
